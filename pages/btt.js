...
import BitTorrent from '../assets/BitTorrent';
import Sidebar from '../assets/Sidebar';
import Head from 'next/head';

const BitTorrentWithNoSSR = dynamic(() => import('../assets/BitTorrent'), {
  ssr: false,
});
        ...
        {({ provider, account, connectWallet, disconnectWallet }) => (
          <>
            ...
            <Head>
              ...
              <meta property="og:description" content="Build and deploy a meme coin instantly on BitTorrent. Fast, secure, and 100% code-free." />
              <meta property="og:type" content="website" />
              <meta property="og:url" content="/btt" />
            </Head>

            <div className="container mx-auto p-4 max-w-7xl flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <BitTorrentWithNoSSR provider={provider} account={account} connectWallet={connectWallet} />
              </div>
